...
#----------------------------------------------------------------------------------------------------------------------------------
symptomsheet = 'C:/Users/sci12/Documents/S - Hackathon/Hackathon Data - Sympyom Chart.csv'
cancersheet = 'C:/Users/sci12/Documents/S - Hackathon/Hackathon Data - Cancer Symptom.csv'
drugsheet = 'C:/Users/sci12/Documents/S - Hackathon/Hackathon Data - Drug Symptom.csv'
othersheet = 'C:/Users/sci12/Documents/S - Hackathon/Hackathon Data - Other Symptom.csv'
...
with open('C:/Users/sci12/Documents/S - Hackathon/Test - January.csv', newline='') as jan:
    reader = csv.reader(jan)
    january = [row for row in reader]
with open('C:/Users/sci12/Documents/S - Hackathon/Test - February.csv', newline='') as feb:
    reader = csv.reader(feb)
    february = [tuple(row) for row in reader]
with open('C:/Users/sci12/Documents/S - Hackathon/Test - March.csv', newline='') as mar:
    reader = csv.reader(mar)
    march = [tuple(row) for row in reader]
with open('C:/Users/sci12/Documents/S - Hackathon/Test - April.csv', newline='') as apr:
    reader = csv.reader(apr)
    april = [tuple(row) for row in reader]
with open('C:/Users/sci12/Documents/S - Hackathon/Test - May.csv', newline='') as may:
    reader = csv.reader(may)
    may = [tuple(row) for row in reader]
with open('C:/Users/sci12/Documents/S - Hackathon/Test - June.csv', newline='') as jun:
    reader = csv.reader(jun)
    june = [tuple(row) for row in reader]
with open('C:/Users/sci12/Documents/S - Hackathon/Test - July.csv', newline='') as jul:
    reader = csv.reader(jul)
    july = [tuple(row) for row in reader]
with open('C:/Users/sci12/Documents/S - Hackathon/Test - August.csv', newline='') as aug:
    reader = csv.reader(aug)
    august = [tuple(row) for row in reader]
with open('C:/Users/sci12/Documents/S - Hackathon/Test - September.csv', newline='') as sep:
    reader = csv.reader(sep)
    september = [tuple(row) for row in reader]
with open('C:/Users/sci12/Documents/S - Hackathon/Test - October.csv', newline='') as octo:
    reader = csv.reader(octo)
    october = [tuple(row) for row in reader]
with open('C:/Users/sci12/Documents/S - Hackathon/Test - November.csv', newline='') as nov:
    reader = csv.reader(nov)
    november = [tuple(row) for row in reader]
with open('C:/Users/sci12/Documents/S - Hackathon/Test - December.csv', newline='') as dec:
