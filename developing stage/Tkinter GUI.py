...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  2 14:10:14 2020
            ...
            def store_cancer_location():
                ...
                if user_choice[2] == 'Peritoneum':
                    def store_cancer_type():
                        ...
                        user_choice.append(user_cancer_type)
                        print(user_choice[3])
                        #Q5
                        if user_choice[3] == 'Peritoneal':
                            def store_drug_options():
                                drug_user_input.append('Xeloda')
                                user_choice.append(drug_user_input)
                                print(user_choice)
                ...
                if user_choice[2] == 'Skin':
                    ...
                    def store_cancer_type():
                        ...
                        #Q5
                        if user_choice[3] == 'Basal Cell Carcinoma, Metastatic':                        
                            def store_drug_options():
                        ...
                        if user_choice[3] == 'Melanoma, Metastatic':
                            options ='Zelboraf'
